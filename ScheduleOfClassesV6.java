...
public class ScheduleOfCourses {
	...
	public static void main(String[] args) {
		...
		ScheduleOfCourses.buildScheduleOfClasses(courseList);
		
		//ScheduleOfCourses.viewScheduleOfClasses(courseList);
		
		//ScheduleOfCourses.viewCourseSections(courseList);
		
		ScheduleOfCourses.enrollACourse(courseList);
	}
	...
	public static void viewCourseSections (Course [] courseList) {		
		...
		do {
			...
			System.out.println("Enter a course title (type 'Quit' if you want to quit): ");
	...
	public static void enrollACourse(Course [] courseList) {
        ...
        for (Course course: courseList) {
        	//I didn't know how to do it without accessors and mutators
        	if(course.getCRN() == Integer.parseInt(CRNChoice) && course.isFull() == false) {
        		
        		//viewScheduleOfClasses(courseList); (just for testing if you want to test it)
        		
        		course.enroll();
     
        		System.out.println("Successfully enrolled");
        		
        		/* (Just for testing if you want to test it)
        		System.out.println("");
        		System.out.println("");
        ...
        if (!working) {
    		System.out.println("Could not be enrolled, course is full");
        }
	}
}
